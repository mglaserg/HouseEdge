...
def test_prereg_requires_calibration_and_sealed_prediction(tmp_path):
    cfg = {
        ...
        "inference": {"primary_trial_count": 1, "stationary_bootstrap_mean_block_days": 17.0},
    ...
    cr.write_text(json.dumps({
        ...
        "bootstrap":{"selected_mean_block_days":17.0},
    }))
...
def test_prepare_freeze_applies_only_calibration_selected_fields(tmp_path):
    cfg={
        ...
        "inference":{"primary_trial_count":1,"stationary_bootstrap_mean_block_days":None},
    }
    ...
    report={
        ...
        "bootstrap":{"selected_mean_block_days":23.0},
    }
